...
namespace Lovatto.MobileInput
{
    public class Weapon : MonoBehaviour
    {
        ...
        public WeaponManager Owner => m_Owner;
        WeaponManager m_Owner;
        ...
        public void PickedUp(WeaponManager c)
        {
            m_Owner = c;
        }
        ...
        public void Selected()
        {
            ...
            WeaponInfoUI.Instance.UpdateAmmoAmount(m_ClipContent, m_Owner.GetAmmo(ammoType));
        ...
        {
            m_Animator.SetFloat("speed", m_Owner.controller.Speed);
            m_Animator.SetBool("grounded", m_Owner.controller.Grounded);
    ...
    public class WeaponEditor : Editor
    {
        ...
        SerializedProperty m_WeaponIcon;
        ...
        void OnEnable()
        {
            ...
            m_WeaponIcon = serializedObject.FindProperty("weaponIcon");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_WeaponIcon);
            EditorGUILayout.PropertyField(m_PrefabRayTrailProp);
